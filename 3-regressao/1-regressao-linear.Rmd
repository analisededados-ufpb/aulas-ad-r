...
author: "Nazareno Andrade (adaptado por Marcus Carvalho)"
output: 
  html_notebook:
    theme: readable
    fig_width: 7
...
cor(countyComplete$poverty, countyComplete$hs_grad)
```
...
mario <- read_delim(here("dados", "marioKart.txt"), delim = "\t", col_types = "diicdddcicic") %>% 
