...
```{r}
notas %>%
  filter(disciplina == "Sistemas Operacionais", periodo == "2017.1") %>%
  summarise(media = mean(nota))

notas %>%
  filter(disciplina == "Sistemas Operacionais", periodo == "2017.2") %>%
  summarise(media = mean(nota))

notas %>%
  filter(disciplina == "Sistemas Distribuidos", periodo == "2017.2") %>%
  summarise(media = mean(nota))

notas %>%
  filter(disciplina == "Avaliacao de Desempenho de Sistemas", periodo == "2017.1") %>%
  summarise(media = mean(nota))
```
