...
```{r}
ratings_raw <- read_csv(here("dados", "ml-latest-small", "ratings.csv"), col_types = "ccdi")
movies <- read_csv(here("dados", "ml-latest-small", "movies.csv"), col_types = "ccc")
...
```{r}
titanic = read.csv(here("dados", "titanic.csv"))
titanic = titanic %>% 
...
permutationTest2(sw5x6, median(rating), treatment = title)
