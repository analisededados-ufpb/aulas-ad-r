...
amostra = here("dados", "sample-lastfm.csv") %>%
  read_csv(col_types = "cddii")
dados = amostra
```
...
Outra coisa: os 4 primeiros notebooks em https://github.com/analise-de-dados-ufpb/aulas-ad1/tree/master/2-inferencia são sobre intervalos de confiança e bootstrap. E tem código. Tem também vários links de livros online no Google Classroom. Na medida que precisar, revise lá.
